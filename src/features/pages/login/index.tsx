...
export const Login = () => {
  return (
    <div className="flex flex-wrap h-screen">
      <div className="lg:w-5/12 w-full bg-neutral-100 flex flex-col items-center pt-16 relative">
      ...
      <div className="lg:flex hidden w-7/12 bg-neutral-100 justify-center items-center p-5">
        <div className="bg-[#fbfef179] h-full w-full flex justify-center items-center rounded-lg"></div>
      </div>
    </div>
  );
};
